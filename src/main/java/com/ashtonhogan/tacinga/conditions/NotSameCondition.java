...
public final class NotSameCondition implements Condition {

    private final ObjectUnit objectUnit;

    public NotSameCondition(final ObjectUnit objectUnit) {
    ...
    public Boolean conforms() throws Exception {
        return this.objectUnit.actual() != this.objectUnit.expected();
    }
